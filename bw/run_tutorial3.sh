...
cpcc set-file fe:in.grompp.top ~/copernicus/test/lib/fe/topol.top
cpcc set-file fe:in.grompp.include[0]  ~/copernicus/test/lib/fe/ana.itp
cpcc set-file fe:in.grompp.mdp ~/copernicus/test/lib/fe/grompp.mdp

cpcc set-file fe:in.conf ~/copernicus/test/lib/fe/conf.gro
